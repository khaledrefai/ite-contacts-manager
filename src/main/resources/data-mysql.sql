...
INSERT INTO `contacts`.`users` (`id`,  `password`, `role`, `username`, `department_department_id`,`active`) VALUES ('1',  'jamous', 'ADMIN', 'neveen', '1',true);
INSERT INTO `contacts`.`users` (`id`,  `password`, `role`, `username`, `department_department_id`,`active`) VALUES ('2',  'caro', 'USER', 'caro', '1',true);
